...
class Player(Ship):
    ...
    def __init__(self, x, y, speed_x, speed_y, angle=0, speed_angle=0, health=100, oil_level=200):
        ...
        self.image_off = SPACE1_IMG
        self.image_on = SPACE1_IMG_FIRE
    ...
    def healthbar(self, window):
        pygame.draw.rect(window, (255,0,0), (self.get_x(), self.get_y() + self.image_off.get_height() + 10,
                                             self.image_off.get_width(), 5))
        pygame.draw.rect(window, (0,255,0), (self.get_x(), self.get_y() + self.image_off.get_height() + 10,
                                             self.image_off.get_width() * (1 - ((self.max_health - self.health)/self.max_health)), 5))
